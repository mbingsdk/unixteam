            ...
            <div className="glass-effect rounded-lg p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input className={inputClass} placeholder="10" value={form.id} onChange={set('id')} />
                </div>
                <div>
                  <label className={labelClass}>Name</label>
                  <input className={inputClass} placeholder="Maez" value={form.name} onChange={set('name')} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input className={inputClass} placeholder="Gatau" value={form.role} onChange={set('role')} />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Jago summit (tapi ke BC 🗿)"
                  value={form.bio}
                  onChange={set('bio')}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="/images/team/maez.png"
                  value={form.image}
                  onChange={set('image')}
                />
              </div>
              ...
              <div className="space-y-3 pt-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input className={inputClass} placeholder="https://tiktok.com/@username" value={form.tiktok} onChange={set('tiktok')} />
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-xs text-foreground/50 w-20 shrink-0">Discord</span>
                  <input className={inputClass} placeholder="muzanlur" value={form.discord} onChange={set('discord')} />
                </div>
              </div>
